...
public record BuildingType
{
    ...
    // economy
    public List<Dictionary<int, int>> Goods_Production = new(); // goods produced by this building (goods id, amount)
    public List<Dictionary<int, int>> Goods_Cost = new(); // goods needed to produce this building (goods id, amount)
