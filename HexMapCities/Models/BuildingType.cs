...
public record BuildingType
{
    ...
    // economy
    public int Food; // level needed by this building
    public int Production; // level needed by this building
    ...
    public Dictionary<int, int> GoodsCost = new(); // goods needed to produce this building (goods id, amount)
    public int ProductionCost; // amount of gold needed to build this building
    public int PurchaseCost; // amount of gold needed to purchase this building (without Goods)
    public int UpkeepCost; // amount of gold needed per round to upkeep this building
}